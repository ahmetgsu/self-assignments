...
# For example, in 5x5 matrix above, there are
# [[2,2],[2,2]], [3,3,3,3], [1,1] and [[4,4], [4,4], [4,4]] quadrangle.
# And the biggest one is the last one. The result will be shown like [4,6]
